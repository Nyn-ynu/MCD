...
src_train_data = get_data("usps", transform=transform)
tgt_train_data = get_data("mnist", transform=transform)
src_test_data = get_data("usps", transform=transform, is_train=False)
tgt_test_data = get_data("mnist", transform=transform, is_train=False)
